...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-additional-packages '(folding)
...
values."
  ...
  (setq-default
   ...
   dotspacemacs-configuration-layers '((multiple-cursors :variables multiple-cursors-backend 'evil-mc))
   ))
...
you should place your code here."
  ...
  ;; use "C-x g" to launch magit
  (with-eval-after-load 'magit (global-set-key (kbd "C-x g") 'magit))
  ...
  (with-eval-after-load 'org
    ...
    (setq google-org-directory "~/googleorg")
  ...
  ;; reload is needed after the setting above for Windows but not MacOS
  (when *is-a-windows* (org-reload))
  ;; #}}}
